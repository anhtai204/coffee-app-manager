...
public class TatCaOthersFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_tat_ca_others, container, false);
        ...
        if (getArguments() != null) {
            ...
            if (user != null) {
                Log.d("TatCaCaPheFragment", "User: " + user.toString());
            }
        }
        ...
        ApiService.apiService.getAllOthers().enqueue(new Callback<ResponseProduct>() {
            @Override
