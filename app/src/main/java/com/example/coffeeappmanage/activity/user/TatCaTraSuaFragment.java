...
public class TatCaTraSuaFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_tat_ca_tra_sua, container, false);
        ...
        if (getArguments() != null) {
            ...
            if (user != null) {
                Log.d("TatCaTraSuaFragment", "User: " + user.toString());
            }
        }
        ...
        ApiService.apiService.getAllTraSua().enqueue(new Callback<ResponseProduct>() {
            @Override
