...
public class TatCaSinhToFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_tat_ca_sinh_to, container, false);
        ...
        if (getArguments() != null) {
            ...
            if (user != null) {
                Log.d("TatCaSinhToFragment", "User: " + user.toString());
            }
        }
        ...
        ApiService.apiService.getAllSinhTo().enqueue(new Callback<ResponseProduct>() {
            @Override
