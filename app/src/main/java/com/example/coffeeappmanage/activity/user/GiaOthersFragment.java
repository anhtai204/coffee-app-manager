...
public class GiaOthersFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_gia_others, container, false);
        ...
        ApiService.apiService.getOthersFilterCost().enqueue(new Callback<ResponseProduct>() {
            @Override
