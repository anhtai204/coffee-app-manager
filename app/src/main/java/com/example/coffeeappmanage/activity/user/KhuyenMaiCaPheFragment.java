...
public class KhuyenMaiCaPheFragment extends Fragment {

    private RecyclerView recyclerViewCaPhe;
    List<Product> listProducts;
    RCProductAdapter rcProductAdapter;

    public KhuyenMaiCaPheFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_khuyen_mai_ca_phe, container, false);
        ...
        ApiService.apiService.getCoffeeFilterSale().enqueue(new Callback<ResponseProduct>() {
            @Override
